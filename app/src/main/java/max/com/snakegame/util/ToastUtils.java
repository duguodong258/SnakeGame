...
import max.com.snakegame.base.SnakeApplication;
...
//        Toast toast = Toast.makeText(context, tvToast.getText(), Toast.LENGTH_SHORT);
//        toast.setView(view);
...
//    }
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(SnakeApplication.context.getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(SnakeApplication.context.getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(SnakeApplication.context, text, duration);
        } else {
            sToast.setText(text);
